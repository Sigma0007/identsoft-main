						...
						<div class="col-lg-3 col-md-6 team-wrap">
							<div class="team-info text-left">
								<div class="column position-relative">
									<a href="#url">
										<img src="{{ asset($contents->images[$i] ?? 'assets/images/ab2.jpg') }}" alt="" class="img-fluid team-image" />
									</a>
								</div>
								<div class="column">
				...
				<div class="row text-center mt-lg-5 mt-4">
					...
					@foreach ($contents2->serviceName ?? [] as $service)
						...
						<div class="col-lg-3 col-md-4 col-sm-6">
							<div class="column">
								<a href="#single"><img src="{{ asset($contents2->images[$j] ?? 'assets/images/g1.jpg') }}" alt="" class="img-responsive" /></a>
